...
/// Where PDFDocEncoding, the encoding of a PDF text string with no byte
/// order mark, differs from Latin-1.
const Map<int, int> pdfDocHigh = {
...
/// A PDF text string's bytes as text: UTF-16 behind its byte order mark,
/// UTF-8 behind its own, and PDFDocEncoding otherwise.
String decodePdfText(List<int> b) {
  ...
  return String.fromCharCodes(<int>[for (final c in b) pdfDocHigh[c] ?? c]);
}
